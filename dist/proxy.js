...
exports.VIXCLOUD_HEADERS = exports.VIXSRC_HEADERS = void 0;
exports.makeProxyToken = makeProxyToken;
exports.decodeProxyToken = decodeProxyToken;
exports.resolveUrl = resolveUrl;
exports.getAddonBase = getAddonBase;
exports.VIXSRC_HEADERS = {
...
function registerHeaders(headers, ttlMs) {
...
function makeProxyToken(url, headers, ttlMs = 6 * 3600 * 1000) {
        ...
        if (raw.hid) {
            ...
            if (!cached) {
                ...
                if (url.includes('vixsrc.to') || url.includes('rabbitstream')) {
                    headers = { ...exports.VIXSRC_HEADERS };
                }
                else if (url.includes('vixcloud') || url.includes('animeunity')) {
                    headers = { ...exports.VIXCLOUD_HEADERS };
                }
                else {
