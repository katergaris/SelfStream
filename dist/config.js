...
exports.DEFAULT_CONFIG = exports.AVAILABLE_LANGUAGES = exports.config = void 0;
...
function decodeConfig(token) {
    try {
        ...
        return {
            ...
            vixLang: parsed.vixLang || exports.DEFAULT_CONFIG.vixLang,
            cinemacityEnabled: parsed.cinemacityEnabled === true,
            cinemacityLang: parsed.cinemacityLang || exports.DEFAULT_CONFIG.cinemacityLang,
            ...
            externalAddonUrl: typeof parsed.externalAddonUrl === 'string' ? parsed.externalAddonUrl.trim() : exports.DEFAULT_CONFIG.externalAddonUrl
        };
    }
    catch {
